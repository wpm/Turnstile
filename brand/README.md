...
| File            | What it is                                                      |
| --------------- | -------------------------------------------------------------- |
| `turnstile.svg` | The primary mark — a turnstile (⊢) in a ring.                  |
...
- **App icons (`#app-icons`):** regenerate from `turnstile.svg`. For
  platform icons that need a filled tile, knock the mark out of a
